        ...
        <main className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 space-y-6">
                    ...
                    <div className="flex-1">
                        <div className="flex items-center gap-3">
                            <EditableField
                                ...
                                onSave={(val) => updateField('businessName', val)}
                                className="text-3xl font-bold"
                                placeholder="Company Name"
                            />
                            <Badge className={
                                vendor.status === 'active' || vendor.status === 'qualified' ? "bg-green-100 text-green-800" :
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                    ...
                    {(vendor.status === 'qualified' || vendor.status === 'compliance_review' || vendor.status === 'onboarding' || vendor.status === 'active' || vendor.onboardingStep) && (
