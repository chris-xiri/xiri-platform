        ...
        <div className="bg-white dark:bg-card border rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="max-w-[800px] mx-auto py-10 px-12 text-sm leading-relaxed text-gray-800 print:py-0 print:px-0 print:shadow-none" style={{ fontFamily: "'Georgia', 'Times New Roman', serif" }}>
                ...
                <div className="text-center border-b-2 border-gray-800 pb-6 mb-8">
                    <h1 className="text-2xl font-bold tracking-wide uppercase text-gray-900 dark:text-gray-100" style={{ letterSpacing: '0.15em' }}>
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Contract ID: {contract.id}</p>
                    {contract.status === 'amended' && (
                        <p className="text-xs text-blue-600 dark:text-blue-400 font-medium mt-1">— AMENDED —</p>
                    )}
                </div>

                {/* Parties */}
                <div className="mb-8">
                    <h3 className="text-sm font-bold uppercase tracking-wide text-gray-700 dark:text-gray-300 mb-3">1. Parties</h3>
                    <p className="mb-2">
                    ...
                    <div className="grid grid-cols-2 gap-6 mt-4">
                        <div className="border rounded-lg p-4 bg-gray-50 dark:bg-gray-900/30">
                            <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">Service Provider</p>
                        ...
                        <div className="border rounded-lg p-4 bg-gray-50 dark:bg-gray-900/30">
                            <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-2">Client</p>
                            <p className="font-bold">{clientName}</p>
                            <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">{clientAddress}</p>
                ...
                {/* Scope of Services */}
                <div className="mb-8">
                    <h3 className="text-sm font-bold uppercase tracking-wide text-gray-700 dark:text-gray-300 mb-3">2. Scope of Services</h3>
                    <p className="mb-4">
                    ...
                    {recurringItems.length > 0 && (
                        <>
                            <p className="text-xs font-bold uppercase tracking-wide text-gray-600 dark:text-gray-400 mb-2">A. Recurring Services</p>
                            {Array.from(
                                ...
                                <div key={locName} className="mb-4">
                                    <div className="bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded-t-lg border border-b-0">
                                        <p className="text-xs font-bold uppercase tracking-wide text-gray-600 dark:text-gray-400">
                                            📍 {locName}
                                        </p>
                                        {items[0]?.locationAddress && (
                                            <p className="text-xs text-gray-500 dark:text-gray-400">{items[0].locationAddress}</p>
                                        )}
                                    </div>
                                    <table className="w-full border border-t-0 text-xs">
                                        <thead>
                                            <tr className="bg-gray-50 dark:bg-gray-900/30 border-b">
                                                <th className="text-left py-2 px-3 font-semibold text-gray-600 dark:text-gray-400">Service</th>
                                                <th className="text-left py-2 px-3 font-semibold text-gray-600 dark:text-gray-400">Frequency</th>
                                                <th className="text-right py-2 px-3 font-semibold text-gray-600 dark:text-gray-400">Monthly Rate</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {items.map((item, idx) => (
                                                <tr key={item.id || idx} className="border-b last:border-0">
                                                    <td className="py-2 px-3">
                                                        {item.serviceType}
                                                        {item.description && (
                                                            <span className="text-gray-500 dark:text-gray-400 block text-[10px]">{item.description}</span>
                                                        )}
                                                    </td>
                            ...
                            <div className="border-2 border-gray-800 rounded-lg p-4 flex justify-between items-center mb-6">
                                <span className="font-bold text-gray-900 dark:text-gray-100">TOTAL MONTHLY RECURRING</span>
                                <span className="text-xl font-bold text-gray-900 dark:text-gray-100">{formatCurrency(recurringTotal || monthlyRate)}/mo</span>
                            </div>
                        </>
                    )}
                    ...
                    {oneTimeItems.length > 0 && (
                        <>
                            <p className="text-xs font-bold uppercase tracking-wide text-gray-600 dark:text-gray-400 mb-2">B. One-Time Services</p>
                            {Array.from(
                                ...
                                <div key={locName} className="mb-4">
                                    <div className="bg-amber-50 dark:bg-amber-950/30 px-4 py-2 rounded-t-lg border border-b-0">
                                    ...
                                    <table className="w-full border border-t-0 text-xs">
                                        <thead>
                                            <tr className="bg-gray-50 dark:bg-gray-900/30 border-b">
                                                <th className="text-left py-2 px-3 font-semibold text-gray-600 dark:text-gray-400">Service</th>
                                                <th className="text-right py-2 px-3 font-semibold text-gray-600 dark:text-gray-400">Flat Fee</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {items.map((item, idx) => (
                            ...
                            <div className="border-2 border-amber-600 rounded-lg p-4 flex justify-between items-center mb-6">
                                <span className="font-bold text-gray-900 dark:text-gray-100">TOTAL ONE-TIME CHARGES</span>
                ...
                {/* Term */}
                <div className="mb-8">
                    <h3 className="text-sm font-bold uppercase tracking-wide text-gray-700 dark:text-gray-300 mb-3">3. Term of Agreement</h3>
                    <p>
                ...
                {/* Compensation */}
                <div className="mb-8">
                    <h3 className="text-sm font-bold uppercase tracking-wide text-gray-700 dark:text-gray-300 mb-3">4. Compensation & Payment</h3>
                    <p className="mb-2">
                ...
                {/* Quality Assurance */}
                <div className="mb-8">
                    <h3 className="text-sm font-bold uppercase tracking-wide text-gray-700 dark:text-gray-300 mb-3">5. Quality Assurance & Compliance</h3>
                ...
                {/* Termination */}
                <div className="mb-8">
                    <h3 className="text-sm font-bold uppercase tracking-wide text-gray-700 dark:text-gray-300 mb-3">6. Termination</h3>
                    <p>
                ...
                {/* General Provisions */}
                <div className="mb-8">
                    <h3 className="text-sm font-bold uppercase tracking-wide text-gray-700 dark:text-gray-300 mb-3">7. General Provisions</h3>
                    <ul className="list-disc pl-6 space-y-1 text-gray-700 dark:text-gray-300">
                ...
                <div className="mt-12 border-t-2 border-gray-800 pt-8">
                    <h3 className="text-sm font-bold uppercase tracking-wide text-gray-700 dark:text-gray-300 mb-6">Signatures</h3>
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-6">
                        IN WITNESS WHEREOF, the parties have executed this Agreement as of the date first written above.
                    </p>
                    <div className="grid grid-cols-2 gap-12">
                        <div className="space-y-6">
                            <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 font-bold">XIRI Facility Solutions, LLC</p>
                            <div>
                                <div className="border-b border-gray-400 h-10"></div>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Signature</p>
                            </div>
                            <div>
                                <div className="border-b border-gray-400 h-6"></div>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Printed Name & Title</p>
                            </div>
                            <div>
                                <div className="border-b border-gray-400 h-6"></div>
                        ...
                        <div className="space-y-6">
                            <p className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 font-bold">{clientName}</p>
                            <div>
                                <div className="border-b border-gray-400 h-10"></div>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Signature</p>
                            </div>
