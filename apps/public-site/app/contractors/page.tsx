...
export const metadata = {
    ...
    twitter: {
        ...
        title: 'Join the XIRI Contractor Network',
        description: 'Get consistent facility management jobs without the sales headaches.',
    },
};
                    ...
                    <div className="relative">
                        ...
                        <div className="grid md:grid-cols-4 gap-8">
                            ...
                            <div className="bg-white pt-4 text-center group">
                                ...
                                <h3 className="text-lg font-bold text-gray-900 mb-2">Get Verified</h3>
                            ...
                            <div className="bg-white pt-4 text-center group">
                                ...
                                <h3 className="text-lg font-bold text-gray-900 mb-2">Get Paid</h3>
                        ...
                        <div className="space-y-8 lg:sticky lg:top-24">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-white">Registered Business Entity</h3>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-white">Licensed & Bonded</h3>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-white">Reliable Scheduling</h3>
                            ...
                            <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 mt-8">
                                <h3 className="font-bold text-sky-400 mb-4">Looking for local partners in:</h3>
