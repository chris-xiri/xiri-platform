...
export default async function MedicalSuiteLocationPage({
    params,
}: {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <h1 className="text-5xl font-bold text-gray-900 mb-6">
                            ...
                            <span className="text-blue-600">For Medical Suites in {location.city}, {location.state}</span>
                        </h1>
                        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                            Your {location.city} medical suite deserves more than just cleaning.
                            Get dedicated facility management with regular site visits, night audits,
                            and comprehensive care - so you can focus on patient care, not facility headaches.
                        </p>
                        <a
                            href="#survey"
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-blue-50 p-8 rounded-lg">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">
                            Serving Medical Suites Throughout {location.city}
                        </h2>
            ...
            <section className="py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
                        Why {location.city} Medical Suites Choose XIRI
                    </h2>
            ...
            <section id="survey" className="bg-blue-600 py-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl font-bold text-white mb-4">
                        Ready to Elevate Your {location.city} Medical Suite?
                    </h2>
