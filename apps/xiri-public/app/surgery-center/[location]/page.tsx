...
export default async function SurgeryCenterLocationPage({
    params,
}: {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <h1 className="text-5xl font-bold text-gray-900 mb-6">
                            ...
                            <span className="text-blue-600">For Surgery Centers in {location.city}, {location.state}</span>
                        </h1>
                        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                            Your {location.city} ambulatory surgery center demands surgical-grade cleanliness.
                            Get dedicated facility management with strict compliance protocols and
                            meticulous attention to sterile environments.
                        </p>
                        <a
                            href="#survey"
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-blue-50 p-8 rounded-lg">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">
                            Serving Surgery Centers Throughout {location.city}
                        </h2>
                        <p className="text-gray-700 mb-4">
                            Accessible to ambulatory surgery centers throughout {location.county} County, including
                            facilities in {location.city} and surrounding areas. Our {location.county}-based
                            facility management team understands surgical facility requirements.
                        </p>
                        <p className="text-gray-700">
                            <strong>Local Coverage:</strong> We're familiar with {location.city} surgery center
                            regulations and maintain the highest standards of cleanliness.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
                        Why {location.city} Surgery Centers Choose XIRI
                    </h2>
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-white p-6 rounded-lg border border-gray-200">
                            ...
                            <p className="text-gray-600">
                                We understand the critical importance of sterile environments and maintain
                                protocols that meet surgical facility requirements.
                            </p>
                        </div>
                        <div className="bg-white p-6 rounded-lg border border-gray-200">
                            <div className="text-4xl mb-4">📋</div>
                            ...
                            <p className="text-gray-600">
                                Complete documentation and tracking for accreditation and regulatory
                        ...
                        <div className="bg-white p-6 rounded-lg border border-gray-200">
                            ...
                            <p className="text-gray-600">
                                Deep cleaning and maintenance performed after surgical hours to ensure
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white p-8 rounded-lg shadow-md">
                            ...
                            <p className="text-gray-600 mb-4">
                                Surgical-grade cleaning protocols for operating rooms, recovery areas, and pre-op spaces.
                                Meticulous attention to sterile environments and infection control.
                            </p>
                            <ul className="text-sm text-gray-600 space-y-2">
                                <li>✓ Surgical suite cleaning</li>
                                <li>✓ Sterile environment protocols</li>
                                <li>✓ Operating room standards</li>
                                <li>✓ Recovery area maintenance</li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-lg shadow-md">
                            ...
                            <p className="text-gray-600 mb-4">
                                ...
                                Safe, effective solutions that meet surgical facility standards.
                            </p>
                            <ul className="text-sm text-gray-600 space-y-2">
                        ...
                        {/* Surgery Center-Specific Service 1: Medical Waste */}
                        <div className="bg-white p-8 rounded-lg shadow-md">
                            ...
                            <p className="text-gray-600 mb-4">
                                Specialized surgical waste disposal including sharps, biohazard materials,
                                and regulated medical waste with full compliance tracking.
                            </p>
                            <ul className="text-sm text-gray-600 space-y-2">
                                <li>✓ Surgical waste removal</li>
                                <li>✓ Sharps container service</li>
                                <li>✓ Biohazard compliance</li>
                                <li>✓ Complete documentation</li>
                            </ul>
                        </div>

                        {/* Surgery Center-Specific Service 2: Sterilization Support */}
                        <div className="bg-white p-8 rounded-lg shadow-md">
                            <div className="text-5xl mb-4">🧪</div>
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">
                            ...
                            <p className="text-gray-600 mb-4">
                                Environmental services that support your sterilization protocols.
                                Maintaining surgical-grade cleanliness in all areas.
                            </p>
                            <ul className="text-sm text-gray-600 space-y-2">
                                <li>✓ Sterile field maintenance</li>
                                <li>✓ OR turnover cleaning</li>
                                <li>✓ Terminal cleaning protocols</li>
                                <li>✓ Infection control support</li>
                            </ul>
                        </div>
            ...
            <section id="survey" className="bg-blue-600 py-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl font-bold text-white mb-4">
                        Ready to Elevate Your {location.city} Surgery Center?
                    </h2>
                    <p className="text-xl text-blue-100 mb-8">
                        Schedule a free facility survey to see how we can help maintain
                        surgical-grade standards for your facility.
                    </p>
                    <a
                        href="#contact-form"
